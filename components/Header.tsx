...
export default function Header({ siteConfig }: { siteConfig: SiteConfig }) {
  return (
    <header className="mb-16">
      ...
      <p
        className="mb-8 text-lg md:text-xl font-light"
      ...
      <nav className="mt-12 flex items-center justify-center gap-6">
        {siteConfig.navigation.showBlogButton && (
          <Link
            href="/blog"
            className="rounded-lg border px-6 py-2 text-sm font-medium transition-all duration-300 hover:border-gray-700/50 hover:bg-gray-800/60 hover:text-white"
            style={{
